...
To test locally with Transformers models, use the `Transformers-offline` mode. See `test_transformers.py` for an example.
...
|   |   ├── openie_transformers_offline.py  # Model for OpenIE with Transformers offline mode
...
|   |   ├── transformers_llm.py     # Class for inference using Transformers library
|   |   ├── transformers_offline.py # Class for offline inference using Transformers
